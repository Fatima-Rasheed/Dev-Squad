              ...
              <div key={item._id} style={{ display: 'flex', gap: '16px', paddingBottom: '20px', marginBottom: '20px', borderBottom: '1px solid #f0f0f0' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <button
                    ...
                    style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: '0.72rem', color: '#999', padding: '0', marginTop: '6px', letterSpacing: '0.05em', textDecoration: 'underline' }}
                  >
                    REMOVE
                  </button>
                </div>
        ...
        {cart.items.length > 0 && (
          <div style={{ borderTop: '1px solid #eee', padding: '20px 24px 24px' }}>
            ...
            <button
              ...
              style={{ width: '100%', backgroundColor: '#1a1a1a', color: '#fff', border: 'none', padding: '16px', fontSize: '0.85rem', letterSpacing: '0.12em', cursor: 'pointer' }}
            >
              PURCHASE
            </button>
          </div>
